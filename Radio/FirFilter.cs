    ...
    public unsafe sealed class FirFilter : IDisposable, IFilter
    {
        ...
        private void ProcessSymmetricKernelInterleaved(float* buffer, int length)
        {
            ...
            for (int n = 0, m = 0; n < length; n += _decimationFactor * 2, m += 2)
            {
                ...
                if (len >= 16)
                {
                    do
                    {
                        acc += ptr1[0] * (ptr2[0] + ptr3[0])
                             ...
                             + ptr1[5] * (ptr2[5] + ptr3[-5])
                             + ptr1[6] * (ptr2[6] + ptr3[-6])
                             + ptr1[7] * (ptr2[7] + ptr3[-7])
                             + ptr1[8] * (ptr2[8] + ptr3[-8])
                             + ptr1[9] * (ptr2[9] + ptr3[-9])
                             + ptr1[10] * (ptr2[10] + ptr3[-10])
                             + ptr1[11] * (ptr2[11] + ptr3[-11])
                             + ptr1[12] * (ptr2[12] + ptr3[-12])
                             + ptr1[13] * (ptr2[13] + ptr3[-13])
                             + ptr1[14] * (ptr2[14] + ptr3[-14])
                             + ptr1[15] * (ptr2[15] + ptr3[-15]);
                ...
                {
                    _offset = _queueSize * (CircularBufferSize - 1);
                    Utils.Memcpy(_queuePtr + _offset + _decimationFactor, queue, (_queueSize - _decimationFactor) * sizeof(float));
                }
